...
export default function MemberRegister() {
  const [data, setData] = useState({ current_period: null, members: [] })
                  ...
                  {data.members.map(p => (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <p className="text-white font-semibold text-sm leading-tight">{memberFullName(p)}</p>
                        {p.alias && <p className="text-brand text-xs leading-tight">"{p.alias}"</p>}
                      </div>
                    </div>
                  ))}
                </div>

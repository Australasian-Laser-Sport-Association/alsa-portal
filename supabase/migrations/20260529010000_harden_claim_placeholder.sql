...
-- Pass 1 security-audit remediation, Critical #2.
--
...
BEGIN
  ...
  -- the placeholder by alias or email. Without this, "claiming for yourself"
  -- meant "claiming any placeholder for yourself" — Critical #2 in the audit.

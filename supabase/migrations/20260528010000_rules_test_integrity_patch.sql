-- =============================================================================
-- Rules Test integrity patch — closes three holes from the security audit:
--
...
--      via service-role. (Was the primary bypass: a player could insert a
--      passed=true row from the console.)
--
...
--
-- Per-method policy hygiene (Issue 4 from the audit) falls out of #1 — the
